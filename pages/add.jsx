...
export default function AddProduct() {
    ...
    const [product, setProduct] = useState({ name: "", details: "", category: "", photos: [] });
            ...
            {dialog ? (
                <div className={styles["dialog-wrapper"]}>
                    <div className={isAdded ? styles.success : styles.error}>
                            {isAdded ? <Check className={styles["dialog-icon"]} /> : <Clear className={styles["dialog-icon"]} />}
                ...
                (
                    <form onSubmit={(e) => handleForm(e)}>
                        ...
                        <div
                            ...
                            <div className={styles.text} onClick={() => setCategoryDisplay(!categoryDisplay)}>
                                {product.category ? product.category : "choose a category"}
                                <ArrowDropDown />
                            </div>

                            <div className={styles.categories} style={{ display: categoryDisplay ? "flex" : "none" }}>
